...
(
  ...
  // Game Logic
  /****************************************************************************/
  reg [27:0] r_game_start_counter = 0;
  // Player
  ...
  reg [28:0] r_enemy_color_counter;
  ...
  begin
    r_game_start_counter = (r_game_start_counter == 28'b1111111111111111111111111111) ? r_game_start_counter : r_game_start_counter + 1;
    // Display
    if (w_display_active)
    begin
    ...
    if (r_enemy_control_counter == 0 && (r_game_start_counter == 28'b1111111111111111111111111111))
    begin
    ...
    if (((r_diff_torpedo_enemy_x < ((TORPEDO_WIDTH  + ENEMY_SIZE) / 2)) &&
      (r_diff_torpedo_enemy_y < ((TORPEDO_HEIGHT + ENEMY_SIZE) / 2))) &&
      (r_torpedo_status == 1) && (r_game_start_counter == 28'b1111111111111111111111111111))
    begin
    ...
    if (((r_diff_player_enemy_x < ((32 + ENEMY_SIZE) / 2)) &&
       ...
       (r_enemy_hit_points > 0) && (r_game_start_counter == 28'b1111111111111111111111111111))
    begin
     r_player_status <= 0;
    end
