...
HD_PWD='Z:/Kise-Research-Centre-Research-Project/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log m_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source m_main.tcl
