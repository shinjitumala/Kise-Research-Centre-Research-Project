...
HD_PWD='Z:/Kise-Research-Centre-Research-Project/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log m_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source m_main.tcl -notrace
